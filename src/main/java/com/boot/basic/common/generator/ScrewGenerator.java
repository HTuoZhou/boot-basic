...
public class ScrewGenerator {
    ...
    public static void main(String[] args) {
        ...
        hikariConfig.setJdbcUrl("jdbc:mysql://localhost:3306/boot_basic?serverTimezone=GMT%2B8&allowPublicKeyRetrieval=true&useSSL=false&characterEncoding=utf8");
        ...
        EngineConfig engineConfig = EngineConfig.builder()
                ...
                //自定义文件名称
                .fileName("boot-basic数据库表结构文档").build();
